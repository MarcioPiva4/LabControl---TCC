    ...
    return(
        <Section title="Cadastre um fornecedor">
            <DefaultForm handleSubmit={formik.handleSubmit}>
                ...
                <Input type="text" label="Telefone" selectAside idInput="telefone" value={formik.values.telefone} onChange={formik.handleChange}  optionsFakeSelect={[
                        {
                            id: 1,
                            nome: "",
                            abr: "g/mol",
                            ...
                            <g clip-path="url(#clip0_349_2866)">
