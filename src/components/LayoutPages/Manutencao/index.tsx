      ...
      <>
        <ContentFilters>
            ...
            <div className="select">
              <svg
                ...
                <g clipPath="url(#clip0_362_9876)">
                  <path
                    d="M2.01 4C2.01 2.9 2.9 2 4 2H20C21.1 2 22 2.9 22 4V16C22 17.1 21.1 18 20 18H6L2 22L2.01 4ZM4 4V17.17L5.17 16H20V4H4Z"
                    fill="white"
                    fillOpacity="0.5"
                  />
                </g>
          ...
          <div className="results">
            <div className="result clear_all">Clear all</div>
          </div>
        </ContentFilters>
