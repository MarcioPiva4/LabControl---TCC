                ...
                <div className="selects">
                    <div className="select">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g clipPath="url(#clip0_362_9870)">
                            <path d="M11.99 2C6.47 2 2 6.48 2 12C2 17.52 6.47 22 11.99 22C17.52 22 22 17.52 22 12C22 6.48 17.52 2 11.99 2ZM12 20C7.58 20 4 16.42 4 12C4 7.58 7.58 4 12 4C16.42 4 20 7.58 20 12C20 16.42 16.42 20 12 20ZM12.5 7H11V13L16.25 16.15L17 14.92L12.5 12.25V7Z" fill="white" fillOpacity="0.5"/>
                            </g>
                            <defs>
                        ...
                        <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M12.75 7.5L9 11.25L5.25 7.5L12.75 7.5Z" fill="white" fillOpacity="0.5"/>
                        </svg>
                    </div>

                    <div className="select">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g clipPath="url(#clip0_362_9876)">
                            <path d="M2.01 4C2.01 2.9 2.9 2 4 2H20C21.1 2 22 2.9 22 4V16C22 17.1 21.1 18 20 18H6L2 22L2.01 4ZM4 4V17.17L5.17 16H20V4H4Z" fill="white" fillOpacity="0.5"/>
                            </g>
                            <defs>
                    ...
                    <div className="select">
                        ...
                        Professor
                        <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M5.25 7.5L9 11.25L12.75 7.5H5.25Z" fill="white" fillOpacity="0.5"/>
                        </svg>
                    </div>
                </div>
