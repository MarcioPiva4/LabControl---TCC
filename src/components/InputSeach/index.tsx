...
export default function InputSearch({placeholder, id, onChange, value}: PropInputSeach){
    return(
        <Content>
            ...
            <InputSearchBox maxLength={100} type="search" id={id} name={id} placeholder={placeholder} onChange={onChange} value={value}></InputSearchBox>
        </Content>
    )
}